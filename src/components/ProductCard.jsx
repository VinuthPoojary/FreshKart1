  ...
  return (
    product && (
      <div
        ...
        className="border border-gray-200 rounded-lg bg-white p-4 w-full h-full flex flex-col justify-between shadow-sm hover:shadow-md transition"
      >
          ...
          <div className="flex items-end justify-between mt-3">
            ...
            <div className="text-green-600">
              {!cartItems[product._id] ? (
                ...
                <div
                  className="flex items-center justify-center gap-2 bg-green-500/20 px-3 py-1.5 rounded"
