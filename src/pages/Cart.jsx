...
import { assets, dummyAddress } from "../assets/assets/assets";
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        ...
        <div className="mb-6">
          ...
          <div className="relative flex justify-between items-start mt-2">
            ...
            {showAddress && (
              <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full z-10 shadow">
        ...
        <button
          onClick={placeOrder}
          className="w-full py-3 mt-6 cursor-pointer bg-green-600 text-white font-medium hover:bg-green-700 transition"
        >
