...
const InputField = ({ type, placeholder, name, handleChange, address }) => (
    ...
    text-gray-500 focus:border-green-600 transition'
    type={type}
  ...
  return (
    <div className='mt-16 pb-16'>
      ...
      <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
       ...
       <InputField handleChange={handleChange} address={address} name='emaail' 
       ...
       <div className='grid grid-cols-2 gap-4'>
        ...
        <button className='w-full mt-6 bg-green-600 text-white py-3
           hover:bg-green-800 transition cursor-pointer uppercase'>
            Save address
        </button>
